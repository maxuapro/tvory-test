    ...
    <main className="flex min-h-screen flex-col items-center justify-between p-24">
      <div className="z-10 w-full max-w-5xl items-center justify-between font-mono text-sm lg:flex">
        <p className="fixed left-0 top-0 flex w-full justify-center border-b border-gray-300 bg-gradient-to-b from-zinc-200 pb-6 pt-8 backdrop-blur-2xl lg:static lg:w-auto lg:rounded-xl lg:border lg:bg-gray-200  lg:p-4 dark:border-neutral-800 dark:bg-zinc-800/30 dark:from-inherit lg:dark:bg-zinc-800/30">
          Test task for&nbsp;
          <code className="font-mono font-bold">Tvory.tech</code>
        </p>
      ...
      <Link
        href="/invites"
        className="my-10 rounded-lg bg-gradient-to-tl from-fuchsia-500 to-indigo-600 px-8 py-3 text-white lg:my-0"
      >
        Try now!
      </Link>
      ...
      <div className="mb-32 grid text-center lg:mb-0 lg:w-full lg:max-w-5xl lg:grid-cols-4 lg:text-left">
        ...
        >
          ...
          <p className="m-0 max-w-[30ch] text-sm opacity-50">
            Check out the Github code fot the project!
          </p>
        </a>
        ...
        >
          ...
          <p className="m-0 max-w-[30ch] text-sm opacity-50">
            Yeah, I wish there was some pricing, but there is no any 😳
          </p>
        </a>
        ...
        >
          ...
          <p className="m-0 max-w-[30ch] text-balance text-sm opacity-50">
            Learn more about the test task
          </p>
        </Link>
      </div>
    </main>
